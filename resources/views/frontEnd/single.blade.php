...
@section('title')
    {{ $settings->site_title }} | {{$post->title }}
@stop
                ...
                <div class="col-lg-10 col-lg-offset-1">
                            ...
                            <div class="post-additional-info">
                                ...
                                <div class="post__author author vcard">
                                    ...
                                    <div class="post__author-name fn">
                                        <a class="post__author-link">{{ $post->user->name }}</a>
                                    </div>
                                ...
                                <a href="{{ route('AllCategory',['id'=>$post->category->id]) }}">{{ $post->category->name }}</a>
                            </span>
                            ...
                            <div class="widget w-tags">
                                <div class="tags-wrap">
                                    @foreach($post->tags as $tag)
                                        <a href="{{ route('AllTags',['id'=>$tag->id]) }}" class="w-tags-item">{{ $tag->tag }}</a>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                        <div class="socials text-center">
                            <div class="addthis_inline_share_toolbox_w6qs"></div>
                        </div>
                    ...
                    <div class="blog-details-author">
                        ...
                        <div class="blog-details-author-content">
                            ...
                            <p class="text">{{ $post->user->profile->bio }}
                            </p>
                            <div class="socials">
                    ...
                    @if($prev_post)
                        <a href="{{ route('SinglePost',['slug'=>$prev_post->slug]) }}" class="btn-next-wrap">
                    ...
                    @endif
                        ...
                        @if ($next_post)
                        <a href="{{ route('SinglePost',['slug'=>$next_post->slug]) }}" class="btn-prev-wrap">
                            <svg class="btn-prev">
                    ...
                    <div class="comments">
                        ...
                        @include('frontEnd.includes.disques')
                    </div>
